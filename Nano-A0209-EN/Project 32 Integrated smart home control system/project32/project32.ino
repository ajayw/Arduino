/*
 * Integrated smart home system ino v1.0.20
 * Date: 2023.9.20
 * Author: Ajay Huajian
...
int setSmokeVal = 100;       //烟雾报警阈值    Set the gas concentration range 100
...
bool doorCheck= false;      //门锁验证状态；false:Access Denied ;true:Access Granted
...
void loop() {
  ...
  Infrared();         //红外控制   Irfrared Control
...
void Infrared(){
  if (irrecv.decode(&results)){   
      ...
      switch(results.value){
          case KEY2:    count_key=1; break;   //Red light
          case KEY3:    count_key=2; break;   //green light
          case KEY4:    count_key=3; break;   //blue light
          case KEY1:    count_key=4; break;   //white light
          case KEY5:    count_key=5; break;   //Hit the OK button to turn off the lights
          case KEY00: windowFlag = true;break;  // Windows automation
          case KEY11: LCD_switch = true;break;  // LCD ON
          case KEY22: LCD_switch = false;break; // LCD OFF
          case KEY33: 
              if(!RelayMode){         //自动感应烟雾报警启动风扇比手动控制风扇优先级高
                RelayBtn = true;
                Relay_switch = true;
              }else{
                RelayBtn = false;
          ...
          case KEY44: 
              ...
              break;
          case KEY55: windowFlag = false;windowStatus = true;break;   //Open Window
          case KEY66: windowFlag = false;windowStatus = false;break;  //close windows
          case KEY77: lockStatus = true;doorControl();break;          //Open the door
          case KEY88: lockStatus = false;doorControl();break;         //Close the door
          default:break;
      }
...
void smoke()
{
  ...
  //Check if the threshold has been reached
    ...
    }else if(!RelayBtn){                    //在无烟雾安全情况下可以手动启动风扇，要加条件!RelayBtn
